...
import { Grid, Card, InputLabel, Input, Typography, useTheme, Select, MenuItem, Button } from '@mui/material'
                    ...
                    >
                        ...
                        <InputLabel htmlFor='role'>Você é um?</InputLabel>
                            <Select
                                ...
                                variant='outlined'
                            >
                                <MenuItem value={'responsible'}>Responsável de um aluno</MenuItem>
                        ...
                        <Grid item margin={2} display='flex' justifyContent='space-between'>
                            ...
                            <Grid item>
                                <Button type='submit' color='secondary'>Criar Conta</Button>
                            </Grid>
                        </Grid>
                    </Grid>
                </form>
